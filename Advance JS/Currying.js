//Currying is a process in JavaScript in which we transform a normal function with multiple arguments into a sequence of functions which takes one argument at a time. eg: sum(a,b,c) into -> sum(a)(b)(c)

//First lets understand that How to call an inner function while calling the outer function which return the inner function.
...
const curriedSumRes = curriedSum(sum);
 ...
 //So now if we call curriedSumRes(a value) function, it will return the function that takes 'b' as parameter and list goes on till last function that takes 'c' as parameter. So we will call it as curriedSumRes(value for a)(value for b)(value for c). 
