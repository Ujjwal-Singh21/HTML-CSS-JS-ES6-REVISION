// -> this keyword in JS is used inside function, refers to the object it belongs to.
...
// -> New Binding -> Explicit Binding -> Implicit Binding -> Default Binding, this is Order of precedence if multiple bindings are mentioned together.
...
displayName.call(person); // this will refer to person object now
...
// So every time the constructor function is invoked using new keyword, everytime under the hood a new empty object gets created and this keyword for each invocation will be pointing to its corresponding empty object.
...
//=============================================================================================
// So if none of the above 3 bindings are specified, JS will default 'this' keyword to global scope and set this keyword pointing to global object, which is called as window Object in case of browsers, hence this -> global = {}
// So in global scope, JS will try to find the particular variable which is 'country' in our case, since it doesn't find it, this.country will be = undefined.
// However we can specify the variable in global scope using 'globalThis' keyword as following syntax -> globalThis.country = 'Europe'
