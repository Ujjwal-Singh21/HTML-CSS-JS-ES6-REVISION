...
// what if laptopName is not available in employee object, hence finding its length 
// will throw erros.
// hence we can use ? operator to avoid errors.
console.log(employee.laptop.laptopName1.length) // says error cant read property
