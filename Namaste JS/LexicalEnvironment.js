...
the variable is the reference to actual object [including function object  
or primitive value].

-> Lexical in general means in hierarchy or in a sequence.Whenever a new execution 
context(EC) is created a new lexical environment  is created and it is referenced in local 
EC in memory space.

-> Lexical Environment: Local Memory + Lexical Environment of its Parent

-> So in short, a lexical environment is a place where variables and functions live or 
physically present during the program execution.
...
/*
  ...
  - So in EC of c(), variables and fun in c (none) + reference of lexical env of parent a() 
    is there
