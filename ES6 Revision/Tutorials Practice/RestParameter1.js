...
// Since args is using rest parameter, its an array, hence we used for of loop to
// iterate it
const result = sum(10, 20, 30, 40, 50)
console.log('Total Sum: ' + result)

// (example-2)
// Assuming that the caller of the sum() function may pass arguments with various kind of 
// data types
// such as number, string, and boolean, but you want to calculate the total of numbers only :
